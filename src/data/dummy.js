...
import { RiContactsLine, RiStockLine, RiStore2Line, RiChat1Line, RiBallPenLine, RiBookletLine } from 'react-icons/ri'
...
export const personalData = [
  {
    ...
    lastname: 'Іванов',
    phone: '380991112233',
    address: 'м. Київ, вул. Першого травня, 1',
    login: 'ivanov',
    password: 'secret',
  ...
  },
  {
    ...
    lastname: 'Петров',
    phone: '380991122334',
    address: 'м. Львів, вул. Зелена, 1',
    login: 'petrov',
    password: 'secret',
    email: 'petrov@gmail.com',
    role: 'кухар'
  },
  // додайте інші записи тут
]
import { FiEdit2, FiTrash2 } from 'react-icons/fi';
function handleEditClick() {
  // тут ваш код для редагування запису
  console.log('Edit button clicked');
}

function handleDeleteClick() {
  // тут ваш код для видалення запису
  console.log('Delete button clicked');
}

const editTemplate = () => <FiEdit2 className="text-xl cursor-pointer text-blue-600" onClick={handleEditClick} />;
const deleteTemplate = () => <FiTrash2 className="text-xl cursor-pointer text-red-600" onClick={handleDeleteClick} />;

export const personalGrid = [
  { field: 'id', headerText: 'ID', width: '60', textAlign: 'Center' },
  { field: 'firstname', headerText: "Ім'я", width: '100', textAlign: 'Center' },
  { field: 'lastname', headerText: 'Прізвище', width: '100', textAlign: 'Center' },
  { field: 'phone', headerText: 'Телефон', width: '100', textAlign: 'Center' },
  { field: 'address', headerText: 'Адреса', width: '200', textAlign: 'Center' },
  { field: 'login', headerText: 'Логін', width: '100', textAlign: 'Center' },
  { field: 'password', headerText: 'Пароль', width: '100', textAlign: 'Center' },
  { field: 'email', headerText: 'Ел. пошта', width: '150', textAlign: 'Center' },
  { field: 'role', headerText: 'Роль', width: '100', textAlign: 'Center' },
  { headerText: 'Редагувати', template: editTemplate, width: '75', textAlign: 'Center' },
  { headerText: 'Видалити', template: deleteTemplate, width: '75', textAlign: 'Center' },
]
